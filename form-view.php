    ...
    <form method="post">
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="text" id="email" name="email" class="form-control" value="<?php echo $_POST["email"] ?? $_SESSION["email"] ?? '';?>"/>
        ...
        <fieldset>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="street" id="street" class="form-control" value="<?php echo $_POST["street"] ?? $_SESSION["street"] ?? '';?>">
                    <span><?php echo $street_error;?></span>
                </div>
                <div class="form-group col-md-6">
                    <label for="streetnumber">Street number:</label>
                    <input type="text" id="streetnumber" name="streetnumber" class="form-control" value="<?php echo $_POST["streetnumber"] ?? $_SESSION["streetnumber"] ?? '';?>">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" id="city" name="city" class="form-control" value="<?php echo $_POST["city"] ?? $_SESSION["city"] ?? '';?>">
                    <span><?php echo $city_error;?></span>
                </div>
                <div class="form-group col-md-6">
                    <label for="zipcode">Zipcode</label>
                    <input type="text" id="zipcode" name="zipcode" class="form-control" value="<?php echo $_POST["zipcode"] ?? $_SESSION["zipcode"] ?? '';?>">
